...
def create_dataset(dataset, look_back=1):
    #1125 adjust look_back (timestep) =2,original parameter 1)`
	dataX, dataY = [], []
...
numpy.random.seed(7)
# load the dataset
dataframe = read_csv('oil_production.csv', usecols=[1], engine='python')
...
look_back = 1
#1125 look_back =1  adjust =look_back=10
...
for i in range(34):
    model.fit(trainX, trainY, epochs=2, batch_size=batch_size, verbose=1, shuffle=False)
    model.reset_states()
# make predictions
